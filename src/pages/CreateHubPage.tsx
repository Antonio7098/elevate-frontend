  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.grid}>
        <div className={styles.card} onClick={() => navigate('/create/blueprint-from-source')}>
        ...
        <div className={styles.card} onClick={() => navigate('/create-questions-from-blueprint')}>
        ...
        <div className={styles.card} onClick={() => navigate('/create-questions-from-scratch')}>
